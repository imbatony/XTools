// -----------------------------------------------------------------------
// <copyright file="SystemDataService.cs" author="imbatony">
//     Copyright (c) Weloveloli Corporation.  All rights reserved.
// </copyright>
// -----------------------------------------------------------------------

namespace XTools.Application.SystemCenter
{
    using System;
    ...
    using XTools.Application.Constants;
    using XTools.Application.SystemCenter.Dtos;
    using XTools.Core;
    ...
    public class SystemDataService : ISystemDataService, IDynamicApiController, ITransient
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemDataService"/> class.
        /// </summary>
